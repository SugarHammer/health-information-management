          ...
          <el-form-item class="input" v-if="ruleForm.yuyuebianhao" label="预约编号" prop="yuyuebianhao">
              <el-input v-model="ruleForm.yuyuebianhao" 
                placeholder="预约编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医师账号" prop="zixunshizhanghao">
          <el-input v-model="ruleForm.zixunshizhanghao" 
              placeholder="医师账号" clearable  :readonly="ro.zixunshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医师账号" prop="zixunshizhanghao">
              <el-input v-model="ruleForm.zixunshizhanghao" 
                placeholder="医师账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医师姓名" prop="zixunshixingming">
          <el-input v-model="ruleForm.zixunshixingming" 
              placeholder="医师姓名" clearable  :readonly="ro.zixunshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医师姓名" prop="zixunshixingming">
              <el-input v-model="ruleForm.zixunshixingming" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zixunshiyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zixunshiyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
